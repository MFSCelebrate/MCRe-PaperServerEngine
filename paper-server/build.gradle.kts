...
tasks.test {
    ...
    // ===== 修复资源加载问题 =====
    // 确保 src/main/resources 被包含在测试的 classpath 中
    classpath = classpath + sourceSets.main.get().resources
    // ============================
    filter {
        excludeTestsMatching("io.papermc.paper.permissions.MinecraftCommandPermissionsTest")
    }
