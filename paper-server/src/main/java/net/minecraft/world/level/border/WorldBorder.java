...
public class WorldBorder extends SavedData {
    public static final double MAX_SIZE = 6.7104000E7F;
    public static final double MAX_CENTER_COORDINATE = 3.3552000E7;
    ...
    double centerX;
    double centerZ;
    int absoluteMaxSize = 33552000;
    WorldBorder.BorderExtent extent = new WorldBorder.StaticBorderExtent(6.7104000E7F);
    ...
    public record Settings(
        ...
        public static final WorldBorder.Settings DEFAULT = new WorldBorder.Settings(0.0, 0.0, 0.2, 5.0, 5, 300, 6.7104000E7F, 0L, 0.0);
        public static final Codec<WorldBorder.Settings> CODEC = RecordCodecBuilder.create(
            instance -> instance.group(
                    Codec.doubleRange(-3.3552000e7, 3.3552000e7).fieldOf("center_x").forGetter(WorldBorder.Settings::centerX),
                    Codec.doubleRange(-3.3552000e7, 3.3552000e7).fieldOf("center_z").forGetter(WorldBorder.Settings::centerZ),
